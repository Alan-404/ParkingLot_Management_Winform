...
{
    public partial class settingPriceFixForm : Form
    {
        public settingPriceFixForm()
        {
            InitializeComponent();
        }
        private void format()
        ...
        private void settingPriceFixForm_Load(object sender, EventArgs e)
        {
            DataTable table = Worker.Instance.getAllSerVice(2);
        ...
        {
            settingPriceFixForm_Load(null, null);
        }
    }
}
